...
class ReportByBreed extends Component {
  ...
  render() {
    ...
    let filteredChocolateCows = chartData.filter(
      element => element.breed === "chocolate cow"
    );
    let months = [];
    ...
    let filteredBrownCows = chartData.filter(
      element => element.breed === "strawberry cow"
    );
    let headOfCowBrown = [];
    let totalMilkBrown = [];
